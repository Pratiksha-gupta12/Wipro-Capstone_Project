...
test.describe('Order Validation Tests', () => {
    ...
    test('TC_ORDER_016 - Verify URL Is Valid',
    async () => {
        expect(
    ...
    test('TC_ORDER_017 - Verify Body Loaded',
    async () => {
        await orderPage.verifyBodyVisible();
    });

    test('TC_ORDER_018 - Verify HTML Loaded',
    async () => {
        await orderPage.verifyHtmlVisible();
    });

    test('TC_ORDER_019 - Verify Title Length',
    async () => {
        expect(
    ...
    test('TC_ORDER_020 - Verify Content Length',
    async () => {
        expect(
