...
- Name: order/order_navigation.spec.js >> Order Navigation Tests >> TC_ORDER_024 - Verify Apparel Navigation
- Location: tests/order/order_navigation.spec.js:24:9

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('link', { name: 'Apparel' }) resolved to 2 elements:
    1) <a href="/apparel" title="Show products in category Apparel"> Apparel </a> aka getByRole('link', { name: 'Apparel', exact: true })
    2) <a href="/apparel" title="Show products in category Apparel">…</a> aka getByRole('link', { name: 'Picture for category Apparel' })

Call log:
  - waiting for getByRole('link', { name: 'Apparel' })
