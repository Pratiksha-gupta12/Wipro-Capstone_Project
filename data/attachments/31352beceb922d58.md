          ...
          - generic [ref=e60]:
            ...
            - generic [ref=e62]:
              ...
              - generic [ref=e76]:
                ...
                - textbox "Email:" [ref=e78]: user1779774576294@gmail.com
                - text: "*"
          - generic [ref=e79]:
...
```ts
  ...
  78  |             page.locator('.result');
  79  | 
  80  |         // Error Locators
  81  |         this.firstNameError =
  82  |             page.locator('#FirstName-error');
  83  | 
  84  |         this.lastNameError =
  85  |             page.locator('#LastName-error');
  86  | 
  87  |         this.emailError =
  88  |             page.locator('#Email-error');
  89  | 
  90  |         this.passwordError =
  91  |             page.locator('#Password-error');
  92  | 
  93  |         this.confirmPasswordError =
  94  |             page.locator('#ConfirmPassword-error');
  95  |     }
  96  | 
  97  | 
  98  |     // =========================================
  99  |     // Open Register Page
  100 |     // =========================================
  101 | 
  102 |     async gotoRegisterPage(){
  103 | 
  104 |         await this.page.goto(
  105 |             'https://demo.nopcommerce.com/register'
  106 |         );
  107 |     }
  108 | 
  109 | 
  ...
  112 |     // =========================================
  113 | 
  114 |     async registerUser(user){
  115 | 
  116 |         await this.genderMale.check();
  117 | 
  118 |         await this.firstName.fill(
  119 |             user.firstName
  120 |         );
  121 | 
  122 |         await this.lastName.fill(
  123 |             user.lastName
  124 |         );
  125 | 
  126 |         // Unique email every time
  127 |         await this.email.fill(
  128 |             `user${Date.now()}@gmail.com`
  129 |         );
  130 | 
  131 |         await this.password.fill(
  132 |             user.password
  133 |         );
  134 | 
> 135 |         await this.confirmPassword.fill(
      |                                    ^ Error: locator.fill: value: expected string, got undefined
  136 |             user.confirmPassword
  137 |         );
  138 | 
  139 |         await this.registerButton.click();
  140 |     }
  141 | 
  142 | 
  143 |     // =========================================
  144 |     // Click Register Button
  145 |     // =========================================
  146 | 
  147 |     async clickRegisterButton(){
  148 | 
  149 |         await this.registerButton.click();
  150 |     }
  151 | 
  152 | 
  153 |     // =========================================
  ...
  155 |     // =========================================
  156 | 
  157 |     async fillFirstName(name){
  158 | 
  159 |         await this.firstName.fill(name);
  160 |     }
  161 | }
  162 | 
  163 | module.exports = { AuthPage };
```