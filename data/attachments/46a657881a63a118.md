...
- Location: tests/product/product.spec.js:4:1
...
Call log:
  ...
  - waiting for locator('.item-box').first()
    - waiting for" https://demo.nopcommerce.com/search?q=computer" navigation to finish...
    - navigated to "https://demo.nopcommerce.com/search?q=computer"
