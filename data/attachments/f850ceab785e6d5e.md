...
- Location: tests/product/product.spec.js:445:5
...
Locator: locator('.product-title').first()
Expected: visible
Timeout: 5000ms
...
```ts
  355 | // //             productPage.productPrice
  356 | // //         ).toBeVisible();
  357 | // //     });
  358 | 
  359 | 
  360 | // test(
  361 | // 'TC_PRODUCT_004 - Verify Product Price Visible',
  362 | // async ({ page }) => {
  363 | 
  364 | //     await page.goto(
  365 | // 'https://demo.nopcommerce.com/desktops'
  366 | //     );
  367 | 
  368 | //     await page.waitForSelector('.product-title a');
  369 | 
