          ...
          - generic [ref=e60]:
            ...
            - generic [ref=e62]:
              ...
              - generic [ref=e76]:
                ...
                - textbox "Email:" [ref=e78]: user1779775025410@gmail.com
                - text: "*"
          - generic [ref=e79]:
...
```ts
  ...
  36  | //     }
  37  | 
  38  | //     async fillFirstName(name){
  39  | //         await this.page.locator('#FirstName').fill(name);
  40  | //     }
  41  | // }
  42  | 
  43  | // module.exports = { AuthPage };
  44  | 
  45  | 
  46  | 
  47  | 
  ...
  114 | 
  115 |         await this.genderMale.check();
  116 | 
  117 |         await this.firstName.fill(
  118 |             user.firstName
  119 |         );
  120 | 
  121 |         await this.lastName.fill(
  122 |             user.lastName
  123 |         );
  124 | 
  125 |         // Unique email every time
  126 |         await this.email.fill(
  127 |             `user${Date.now()}@gmail.com`
  128 |         );
  129 | 
  130 |         await this.password.fill(
  131 |             user.password
  132 |         );
  133 | 
> 134 |         await this.confirmPassword.fill(
      |                                    ^ Error: locator.fill: value: expected string, got undefined
  135 |             user.confirmPassword
  136 |         );
  137 | 
  138 |         await this.registerButton.click();
  139 |     }
  140 | 
  141 | 
  142 |     // =========================================
  143 |     // Click Register Button
  144 |     // =========================================
  145 | 
  146 |     async clickRegisterButton(){
  147 | 
  148 |         await this.registerButton.click();
  149 |     }
  150 | 
  151 | 
  152 |     // =========================================
  ...
  154 |     // =========================================
  155 | 
  156 |     async fillFirstName(name){
  157 | 
  158 |         await this.firstName.fill(name);
  159 |     }
  160 | }
  161 | 
  162 | module.exports = { AuthPage };
```