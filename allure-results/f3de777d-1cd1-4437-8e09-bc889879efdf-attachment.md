...
- Name: product/filter.spec.js >> Product Filter Tests >> TC_PRODUCT_026 - Verify Products Remain Visible After Filtering
- Location: tests/product/filter.spec.js:85:9
...
Call log:
  - waiting for locator('label[for="attribute-option-7"]')
